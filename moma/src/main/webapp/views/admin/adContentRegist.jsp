...
/* 		// upload file name change
		...
		$('input[name="reserve"]').on('click', function(){
			if ($(this).is(':cheked'){
				$(this).val("Y");
			} else {
				$(this).val("N");
...
<div class="container_middle">
	...
	<form action="adContentRegistAction.so" method="post" name="frm" enctype="multipart/form-data">
		<!-- 제목 -->
		<div class="adCheck">
			<input type="text" name="cname" placeholder="컨텐츠 제목 *" required="required" autofocus="autofocus">
		</div>
		
		<!-- 분류 -->
		<div class="adCheck">
			<div class="option_title">분류 선택 </div>
				<input class="magic-radio" type="radio" name="sort" value="m" checked="checked" id="s1"><label for="s1">영화</label>
				<input class="magic-radio" type="radio" name="sort" value="d"  id="s2"><label for="s2">드라마</label>
				<input class="magic-checkbox" type="checkbox" name="reserve" value="" id="c1"><label for="c1">예매가능</label>
		</div>
		
		<!-- 연령등급 -->
		<div class="adCheck">
			<div class="option_title">연령 등급 선택</div>
				<input class="magic-radio" type="radio" name="clevel" value="7" checked="checked" id="l1"><label for="l1">7세 이상</label>
				<input class="magic-radio" type="radio" name="clevel" value="12"  id="l2"><label for="l2">12세 이상</label>
				<input class="magic-radio" type="radio" name="clevel" value="15"  id="l3"><label for="l3">15세 이상</label>
				<input class="magic-radio" type="radio" name="clevel" value="18"  id="l4"><label for="l4">18세 이상</label>				
		</div>
		...
		<div class="adCheck">
			<div class="option_title">OTT URL 입력 </div>
				<div>넷플릭스 : <input type="url" class="url" name="netflix"></div>
				<div>왓챠 : <input type="url" class="url" name="watcha"></div>
				<div>티빙 : <input type="url" class="url" name="tving"></div>
		</div>
