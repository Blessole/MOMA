...
public class AdContentRegistAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("AdContentRegistAction 자바파일 지나감");
		...
		try {
			...
			System.out.println("oldFile1="+oldFile);
			System.out.println("newFile1="+newFile);
			
			oldFile.renameTo(newFile);
			
			/*
			 * while(!oldFile.renameTo(newFile)) { newFileName = newFileName+ext; newFile =
			 * new File(savePath + '/' + newFileName); }
			 */
			
			System.out.println("rename oldFile="+oldFile);
			System.out.println("rename newFile="+newFile);
			//savePath = request.getContextPath()+"/img/poster/"+newFileName;
		...
		System.out.println("AdContentRegistAction 자바파일 지나감22");
